...
| Date | Change | Why |
|---|---|---|
| 2026-04-12 | PDF **compact** preset: A4 **portrait**, minimal margins, 5 pt tables + leading clearance, tighter km/Pkt. columns → wider Name/Verein | Fewer pages, less overflow, text clears table rules; [`backend/export/spec.py`](backend/export/spec.py), [`backend/export/pdf_renderer.py`](backend/export/pdf_renderer.py), [`backend/export/gui_pdf_spec.py`](backend/export/gui_pdf_spec.py) |
